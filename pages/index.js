        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-card group hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold text-white mb-3">AI Reasoning Engine</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
                Advanced AI decision-making with 1024 tokens for deep thinking before every automated action.
              </p>
            </div>
            ...
            <div className="glass-card group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Seamless automation of social media posting, SEO optimization, and repetitive mobile tasks.
              </p>
            </div>
            ...
            <div className="glass-card group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Real-time insights and detailed reports on automation performance and productivity gains.
              </p>
            </div>
            ...
            <div className="glass-card group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Enterprise-grade security with local processing and full control over data privacy settings.
              </p>
            </div>
